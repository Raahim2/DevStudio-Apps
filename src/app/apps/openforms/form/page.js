...
function FormRedirectContent() {
  const searchParams = useSearchParams();
  const formId = searchParams.get('formId'); // Parsed from ?formId=...
  
  const playStoreUrl = "https://play.google.com/store/apps/details?id=com.raahim2.openforms";
  const appDeepLink = `openforms://form/${formId}`;
  ...
  return (
    <div style={styles.container}>
      {/* FIXED: Restored standard keyframe CSS syntax */}
      ...
      <div style={styles.wrapper}>
        ...
        {formId ? (
          ...
          <div style={styles.errorWrapper}>
            ...
            <h2 style={styles.errorTitle}>Invalid Form Link</h2>
            <p style={styles.errorText}>
              A valid Form ID is required to redirect. Please check your link and try again.
            </p>
          </div>
        )}
      </div>
