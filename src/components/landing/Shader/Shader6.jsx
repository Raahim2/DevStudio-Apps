...
export function Shader6({ className = "" }) {
  ...
  useEffect(() => {
    ...
    // Set initial mouse coordinates based on initial size
    const initialWidth = container.clientWidth;
    const initialHeight = container.clientHeight;
    uniforms.iMouse.value.set(initialWidth / 2, initialHeight / 2);
    ...
    // 5) Mouse handler (adjusted to be bounds-relative)
    const onMouseMove = (e) => {
