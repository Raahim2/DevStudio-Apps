...
export function Shader4() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Dispose WebGL renderer resources
      if (sceneRef.current.renderer) {
        sceneRef.current.renderer.dispose()
      }
      
      // Safely remove the dynamic script from head
  ...
  const initThreeJS = () => {
    ...
    // Assign handler to reference for future unmounting cleanup
